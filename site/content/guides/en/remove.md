## title
How to remove a Google review (and how to report a fake one)

## dek
Most genuine Google reviews cannot be deleted, even the ones that sting. This guide is for the owner who has just found a 1-star they did not expect, and wants the legal next step, not a miracle.
...
While you wait, do not pick a fight in the reply. Do not mention that you have reported it. A public argument makes a genuine dispute look like a genuine dispute, which is one reason removals fail.
...
If the listing is being hit by an extortion scam (pay us or we post 1-stars), Google has a separate path for that. Use it. Then keep asking every customer, fairly, with the same QR, so one fake line is not the only recent word on the page.

## sources
- [Google — report inappropriate reviews](https://support.google.com/business/answer/4596773)
- [Google — prohibited and restricted content](https://support.google.com/contributionpolicy/answer/7400114)
- [Google — manage customer reviews](https://support.google.com/business/answer/3474050)

## wa_prefill
Hi Rosalia, I read the guide on how to remove a Google review.
