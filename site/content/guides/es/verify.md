...
## dek
Si no hay botón de Responder en las reseñas, lo más probable es que la ficha no esté verificada, o que haya iniciado sesión con otra cuenta de Google. Verificar es cómo toma la titularidad del perfil y empieza a contestar.
...
Si el botón Responder sigue sin salir: compruebe que está en la misma cuenta de Google que es titular de la ficha. Un Gmail del personal no basta si el perfil vive en otro inicio de sesión. Pida al titular que le añada como gestor, no como segundo propietario, en Ajustes del perfil, Personas y acceso.

Si vuelve a aparecer Verificar cuando usted creía que ya estaba, Google no terminó. Pruebe el siguiente método que muestren. No cree una segunda ficha para «empezar de cero». Los duplicados duelen más de lo que ahorran.
